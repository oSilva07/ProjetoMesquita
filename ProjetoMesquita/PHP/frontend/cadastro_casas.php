...
$sqlCasas = "SELECT id_casa, nome FROM tb_casas";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['nome'])) {
    ...
    try {
        ...
        $sql = "INSERT INTO tb_casas (nome) VALUES (:nome)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    try {
        ...
        $sql = "DELETE FROM tb_casas WHERE id_casa = :id";
        $stmt = $pdo->prepare($sql);
