...
<body>
    ...
    <div class="main-content">
        <div class="menu-container">
            ...
            <div class="menu-grid">
                <?php
                    $nivel = strtolower($usuario_classe ?? '');

                    if ($nivel === 'professor') {
                        // Apenas atribuição de notas
                        echo '<a href="atribuir_notas.php">Atribuição de Notas</a>';
                    } elseif ($nivel === 'professor coordenador') {
                        // Atribuição de notas e cadastro de alunos
                        echo '<a href="atribuir_notas.php">Atribuição de Notas</a>';
                        echo '<a href="cadastro_alunos.php">Cadastro de Alunos</a>';
                    } else {
                        // Administrador ou outros: todos os botões
                        echo '<a href="cadastro_usuarios.php">Cadastro de Usuários</a>';
                        echo '<a href="cadastro_alunos.php">Cadastro de Alunos</a>';
                        echo '<a href="cadastro_turmas.php">Cadastro de Turmas</a>';
                        echo '<a href="cadastro_casas.php">Cadastro de Casas</a>';
                        echo '<a href="atribuir_notas.php">Atribuição de Notas</a>';
                    }
                ?>
            </div>
